...
<script>
import editorImage from '@/components/fields/field-wysiwyg/components/EditorImage'
...
export default {
  ...
  props: {
    ...
    // TinyMCE 4 Skin Tool
    // http://skin.tiny.cloud/t4/

    // https://github.com/johnfort/TinyMCE.skins/tree/master/dark-slim
    skin: {
      type: String,
      required: true,
      validator: function (value) {
          return Object.keys(wysiwygTypes).indexOf(value) !== -1
      }
    },
    theme: {type: String, default: 'modern'}, // modern

    menubar: {type: String, default: 'file edit insert view format table'},
    height: {type: [Number, String], required: false, default: 260},
